...
class LoginSignupScreen extends StatefulWidget {
  final bool? isSignup;
  const LoginSignupScreen({super.key, this.isSignup});
...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  void initState() {
    super.initState();
    // Delete any existing controller first to ensure fresh controllers
    if (Get.isRegistered<LoginSignupController>()) {
      Get.delete<LoginSignupController>(force: true);
    }
    c = Get.put(LoginSignupController());
    if (widget.isSignup != null) {
      c.isLogin.value = !widget.isSignup!;
    }
  }
