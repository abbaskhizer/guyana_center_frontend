          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 25),
                _OtherCategoriesRow(excludeId: category.id),
              ],
            ),
          ),
        ],
                ...
                child: centered(
                  Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      _OtherCategoriesRowWeb(excludeId: category.id),
        ...
        Builder(
          builder: (ctx) => InkWell(
            ...
            child: Padding(
              ...
              child: Icon(Icons.menu_rounded, color: cs.onSurface, size: 26),
            ),
          ),
        ),
      ...
      return LayoutBuilder(
        builder: (context, constraints) {
          ...
          return GridView.builder(
            ...
            itemBuilder: (_, i) => ListingCardGrid(
              item: list[i],
              onFavoriteTap: () => controller.toggleFavorite(list[i]),
            ),
          );
        },
      );
...
class _OtherCategoriesRow extends StatelessWidget {
  ...
  const _OtherCategoriesRow({required this.excludeId});
...
class _OtherCategoriesRowWeb extends StatelessWidget {
  final String excludeId;
  const _OtherCategoriesRowWeb({required this.excludeId});
...
class ListingCardGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Get.to(() => const ListingDetailScreen(), arguments: item),
      child: Container(
        decoration: BoxDecoration(
          color: Theme.of(context).cardColor,
