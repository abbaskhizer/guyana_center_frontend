                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  const Icon(Icons.stars_rounded, color: Color(0xFFF5B301), size: 24),
                                  const SizedBox(width: 8),
                                  Text(
                                    "Saved Searches",
                                    style: theme.textTheme.titleMedium?.copyWith(
                                ...
                                child: Container(
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: Icon(Icons.add_rounded, color: theme.colorScheme.primary),
                                      suffixIcon: Obx(() => c.searchInputText.value.isNotEmpty 
                                        ? IconButton(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FeaturedItemCard(
        ...
        isFavorite: true, // Always true since it's on the favorites screen
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            ...
            TextButton.icon(
              onPressed: onView,
              icon: const Text("View", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
