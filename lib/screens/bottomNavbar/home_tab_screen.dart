              ...
              children: controller.featuredListings
                  .map(
                    (item) => Padding(
                      ...
                      child: _ListingCard(
                        item: item,
                        onFav: () => controller.toggleListingFav(item),
                      ),
                    ),
                  )
                  .toList(),
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: web
              ? _WebSearchBar(controller: Get.find<HomeTabController>())
              : _SearchBar(controller: Get.find<HomeTabController>()),
        ),
      ],
    );
  }
...
class _ListingCard extends StatelessWidget {
  ...
  ImageProvider _getImageProvider() {
    ...
    return NetworkImage('$baseUrl${item.imageUrl}');
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () => Get.toNamed('/listing-detail', arguments: item),
      child: Container(
        decoration: BoxDecoration(
